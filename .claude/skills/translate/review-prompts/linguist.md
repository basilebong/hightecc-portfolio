...
5. **Punctuation**: quotation mark style, missing Oxford commas when the rest of the string uses them, doubled spaces. Em dashes are forbidden brand-wide; if you see one, flag it (the brand-voice reviewer will also catch it).
